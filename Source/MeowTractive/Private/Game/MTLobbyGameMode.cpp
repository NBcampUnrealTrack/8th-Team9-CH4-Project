...
AMTLobbyGameMode::AMTLobbyGameMode()
{
	...
	// TODO: 도시맵(Scifi_ModernCity) 용량 문제로 저장소 제외 중 — 복귀 시 원래 경로로 교체
	MatchMaps.Add(EMTRoomMap::City, TSoftObjectPtr<UWorld>(FSoftObjectPath(TEXT("/Game/ThirdPerson/Maps/ThirdPersonMap.ThirdPersonMap"))));
